        ...
        <div className="absolute">
          ...
          <div className="text-xl 2xl:text-2xl bigger-screens:text-3xl leading-none tracking-tight pt-8 bigger-screens:pt-16 px-6 lg:px-[7.5rem] 2xl:px-20 bigger-screens:px-64 max-w-3xl bigger-screens:max-w-7xl">
            ...
            <div className="pt-6 2xl:pt-10 bigger-screens:pt-16">
              <div className={titan.className}>
                <button className="border-2 rounded-xl border-zinc-950 bg-amber-600 transition-all duration-1000 hover:bg-zinc-950 hover:text-amber-600 py-3 px-3 sm:px-4 sm:py-4">
                  <a href="#about">Who we Are</a>
                </button>
                <button className="border-2 rounded-xl border-zinc-950 bg-amber-600 transition-all duration-1000 hover:bg-zinc-950 hover:text-amber-600 py-3 px-3 sm:px-4 sm:py-4 mx-3 lg:mx-4">
